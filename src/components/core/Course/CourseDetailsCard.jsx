...
const CourseDetailsCard = ({
  ...
  return (
    <>
      <div className="flex flex-col max-w-[380px] justify-center gap-4 p-5 rounded-md bg-slate-700 text-richblack-25 courseDetails">
        {/* Course Image */}
        ...
        <div className="">
          ...
          <div className="flex flex-col gap-4 font-poppins">
            ...
            {(!user || !course?.studentsEnrolled.includes(user?._id)) && (
              <button
                className="px-4 py-3 font-medium rounded-md bg-[#1b1f31] hover:bg-slate-700 text-slate-300 hover:text-slate-200"
