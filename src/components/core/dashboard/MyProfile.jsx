...
const MyProfile = () => {
    ...
    return (
        <div className="relative flex flex-col w-full mx-auto">
            ...
            <div className="relative flex flex-row justify-between w-10/12 max-w-[1000px] p-7 mx-auto mt-8 rounded-lg text-slate-200 bg-[#28344d] border-[1px] border-[#545480]">
