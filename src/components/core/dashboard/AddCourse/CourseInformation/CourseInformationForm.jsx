  ...
  return (
    <div className=" text-slate-300">
      <form
        ...
        className="w-full p-5 space-y-8 bg-[#161e2c] border-slate-500 rounded-xl text-richblack-50 text-[15px]"
      >
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            ...
            className="w-full px-2 py-3 text-sm rounded-md shadow-sm shadow-slate-500 bg-richblack-700 text-slate-400 outline-none focus:border-slate-500 focus:border-[1px] min-h-[140px]"
          />
        ...
        <div className="relative flex flex-col space-y-2">
          ...
          <input
            ...
            className="w-full pr-2 pl-12 py-3 text-sm rounded-md shadow-sm shadow-slate-500 bg-richblack-700 text-slate-400 outline-none focus:border-slate-500 focus:border-[1px]"
          />
        ...
        <div className="flex flex-col space-y-2">
          ...
          <select
            ...
            className="w-full px-2 py-3 text-sm rounded-md shadow-sm shadow-slate-500 bg-richblack-700 text-slate-400 outline-none focus:border-slate-500 focus:border-[1px] cursor-pointer"
          >
            <option
              value=""
              disabled
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            ...
            className="w-full px-2 py-3 text-sm rounded-md shadow-sm shadow-slate-500 bg-richblack-700 text-slate-400 outline-none focus:border-slate-500 focus:border-[1px] min-h-[120px]"
          />
