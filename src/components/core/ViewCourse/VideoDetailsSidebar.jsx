...
const VideoDetailsSidebar = ({ setReviewModal }) => {
  ...
  return (
    <>
      {showSidebar && (
        <div className="mt-14 flex md:relative fixed z-[50] h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] md:bg-opacity-100 bg-opacity-35 backdrop-blur-md border-r-slate-600 bg-slate-800">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex items-center justify-between gap-x-3">
                <button
                  ...
                  className="relative px-4 py-2 text-sm font-semibold transition-all duration-200 transform bg-teal-500 rounded-md shadow-md group bg-opacity-85 text-slate-900 shadow-slate-900 hover:bg-teal-600 hover:text-slate-100 hover:scale-95"
                >
                  + Review
                ...
                <button
                  ...
                  className="relative p-2 text-lg font-semibold bg-teal-500 rounded-full shadow-md group hover:cursor-pointer shadow-slate-950 text-slate-900 hover:bg-slate-300"
                >
                  <RiMenuFold3Fill />
      ...
      {!showSidebar && (
        <div
          ...
          className="relative group hover:cursor-pointer h-fit w-fit p-2 mt-16 text-xl font-semibold bg-teal-500 rounded-full left-2 text-slate-900 hover:bg-slate-200 z-[50] bg-opacity-50 md:bg-opacity-100 shadow-md md:shadow-blue-200 shadow-blue-200 backdrop-blur-md"
        >
          <RiMenuUnfold3Fill />
