...
const ExploreMore = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-center font-inter text-slate-400 font-medium">
                ...
                {tabsUsed.map((element, index) => {
                    return (
                        <div
                            ...
                            } rounded-full transition-all cursor-pointer hover:bg-[#19333a] hover:text-slate-300 px-4 py-2 duration-150 active:bg-slate-500`}
                            key={index}
