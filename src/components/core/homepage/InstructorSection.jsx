...
import ins_img from "../../../assets/Images/Instructor.png";

const InstructorSection = () => {
    return (
        <div className="flex sm:flex-row flex-col my-32 mx-auto justify-around items-center">
            <img
                src={ins_img}
                alt="instructor"
            ...
            <div className="relative sm:w-2/5 w-[3/5] my-10 h-full sm:items-start items-center sm:my-auto flex flex-col sm:justify-center justify-start text-start">
                <p className="text-white text-4xl font-inter">
                    Become an <br />
