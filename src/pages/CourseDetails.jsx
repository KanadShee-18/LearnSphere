        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="flex flex-col w-full gap-4 py-4 border-y border-y-slate-600 lg:hidden">
              ...
              <button
                className="px-4 py-2 font-medium bg-teal-500 rounded-md hover:bg-teal-600 text-slate-800 hover:text-slate-200"
                onClick={handleBuyCourse}
              >
                Buy Now
              </button>
              <button className="px-4 py-2 font-medium rounded-md bg-slate-700 hover:bg-slate-800 text-slate-300 hover:text-slate-200">
                Add to Cart
              </button>
            </div>
          </div>
